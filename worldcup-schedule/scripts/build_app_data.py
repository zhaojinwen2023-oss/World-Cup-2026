...
def build_app_data(static_path: Path, live_path: Path, standings_path: Path, knockout_path: Path, output_path: Path) -> dict:
...
def main() -> int:
    ...
    payload = build_app_data(args.static, args.live, args.standings, args.knockout, args.output)
